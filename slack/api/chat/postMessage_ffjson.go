...
func (j *PostMessageRequest) MarshalJSON() ([]byte, error) {
...
func (j *PostMessageRequest) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
...
const (
	ffjtPostMessageResponsebase = iota
	ffjtPostMessageResponsenosuchkey

	ffjtPostMessageResponseMessage
)

var ffjKeyPostMessageResponseMessage = []byte("message")

// UnmarshalJSON umarshall json - template of ffjson
func (j *PostMessageResponse) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *PostMessageResponse) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtPostMessageResponsebase
	_ = currentKey
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtPostMessageResponsenosuchkey
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyPostMessageResponseMessage, kn) {
						currentKey = ffjtPostMessageResponseMessage
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyPostMessageResponseMessage, kn) {
					currentKey = ffjtPostMessageResponseMessage
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtPostMessageResponseMessage:
					goto handle_Message

				case ffjtPostMessageResponsenosuchkey:
...
handle_Message:
	...
	/* handler: j.Message type=chat.Message kind=struct quoted=false*/
