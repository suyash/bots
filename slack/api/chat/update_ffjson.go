...
func (j *UpdateRequest) MarshalJSON() ([]byte, error) {
...
func (j *UpdateRequest) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
...
const (
	ffjtUpdateResponsebase = iota
	ffjtUpdateResponsenosuchkey

	ffjtUpdateResponseChannel

	ffjtUpdateResponseTs

	ffjtUpdateResponseText
)

var ffjKeyUpdateResponseChannel = []byte("channel")

var ffjKeyUpdateResponseTs = []byte("ts")

var ffjKeyUpdateResponseText = []byte("text")

// UnmarshalJSON umarshall json - template of ffjson
func (j *UpdateResponse) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *UpdateResponse) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtUpdateResponsebase
	_ = currentKey
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtUpdateResponsenosuchkey
				...
				case 'c':
					...
					if bytes.Equal(ffjKeyUpdateResponseChannel, kn) {
						currentKey = ffjtUpdateResponseChannel
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffjKeyUpdateResponseTs, kn) {
						currentKey = ffjtUpdateResponseTs
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyUpdateResponseText, kn) {
						currentKey = ffjtUpdateResponseText
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.SimpleLetterEqualFold(ffjKeyUpdateResponseText, kn) {
					currentKey = ffjtUpdateResponseText
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyUpdateResponseTs, kn) {
					currentKey = ffjtUpdateResponseTs
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyUpdateResponseChannel, kn) {
					currentKey = ffjtUpdateResponseChannel
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtUpdateResponseChannel:
					goto handle_Channel

				case ffjtUpdateResponseTs:
					goto handle_Ts

				case ffjtUpdateResponseText:
					goto handle_Text

				case ffjtUpdateResponsenosuchkey:
