...
func (j *OAuthPayload) MarshalJSON() ([]byte, error) {
...
func (j *OAuthPayload) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
...
// MarshalJSON marshal bytes to json - template
func (j *OAuthPayloadBot) MarshalJSON() ([]byte, error) {
	var buf fflib.Buffer
	if j == nil {
		buf.WriteString("null")
		return buf.Bytes(), nil
...
// MarshalJSONBuf marshal buff to json - template
func (j *OAuthPayloadBot) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
